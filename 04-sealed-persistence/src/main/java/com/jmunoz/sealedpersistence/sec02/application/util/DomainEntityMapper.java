package com.jmunoz.sealedpersistence.sec02.application.util;
...
import com.jmunoz.sealedpersistence.sec02.persistence.entity.CheckingAccount;
import com.jmunoz.sealedpersistence.sec02.persistence.entity.SavingsAccount;

public class DomainEntityMapper {

    // Para pasar de nuestro dominio a la entidad.
    ...
    public static AccountType toDomain(Account account) {
        return switch (account) {
            ...
            default -> throw new IllegalStateException("Unexpected value: " + account);     // No debe ocurrir nunca.
        };
    }
}
